...
var EduZone = (function () {
    ...
    var fileInput = function () {
        ...
        jQuery(document).on("change", ".btn-file :file", function () {
            ...
            var label = input
                .val()
                .replace(/\\/g, "https://educare.w3itexperts.com/")
                .replace(/.*\//, "");
